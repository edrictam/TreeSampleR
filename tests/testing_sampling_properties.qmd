...
save(wilson.edge1.list , wilson.edge2.list,  file = "wilson_edge_inclusion_samples_1000.RData")
```
...
ggplot(data.wilson, aes(x)) +
  ...
  xlim(N*p.1 -N/10 , N*p.1 +N/10 ) + 
  geom_vline(xintercept=N*p.1, color = "red") +
  ggtitle("Histogram of bottleneck edge inclusion for Wilson algorithm") + 
  xlab("Counts of edge inclusion out of 1000 generated trees")
